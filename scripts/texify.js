  ...
  function(response) {
    if (JSON.parse(response.answer)) {
      ...
      var mathjax = document.createElement('script');
        ...
        mathjax.src = chrome.runtime.getURL('lib/MathJax/MathJax.js?config=TeX-AMS-MML_HTMLorMML&delayStartupUntil=configured');
      ...
      pageScript.src = chrome.runtime.getURL('scripts/pageScript.js'); 
